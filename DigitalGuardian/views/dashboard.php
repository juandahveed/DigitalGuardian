    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 text-center">
                ...
                <a href="register_child.php" role="button" id="register_child" class="btn btn-default">Register Children</a>
            </div>
            <div class="col-xs-12 text-center">
                <h3 class="text_white">
                    Create a Teacher
                ...
                <!--<button id="register_child" class="btn btn-default">Register Children</button>-->
                <a href="create_teacher.php" role="button" id="create_teacher" class="btn btn-default">Create Teacher</a>
            </div>
            <div class="col-xs-12 text-center">
                <h3 class="text_white">
                ...
                <a href="assign_teacher.php" role="button" id="assign_teacher" class="btn btn-default">Check-In Teacher</a>
            </div>
            <div class="col-xs-12 text-center">
                <h3 class="text_white">
